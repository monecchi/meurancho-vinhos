...
const ProductTopBar = ({ title }: Props) => {
			...
			<header className='border-b bg-zinc-100 px-safe dark:border-zinc-800 dark:bg-zinc-900'>
				<div className='header-mobile mx-auto flex max-w-screen-md items-center justify-between px-6'>
					<Link href='/' scroll={false}>
						<a>
							<h1 className='font-medium'><span className='flex items-center justify-start font-bold truncate'><ChevronLeftIcon className='h-6 w-6 text-red-500 inline-flex mr-2' /> {title}</span></h1>
						</a>
					</Link>
